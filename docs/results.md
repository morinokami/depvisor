...
| `open-pr-blocked`    | A human pushed to the PR branch, so depvisor refuses to force-push over their commits — including during conflict refresh. Merge or close the PR to hand the branch back.                                                               |
